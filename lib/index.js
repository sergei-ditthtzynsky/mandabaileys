...
console.log(chalk.cyan("Telegram: ") + chalk.greenBright("@ditthtzy"));
console.log(chalk.gray("------------------------------\n"));

fetch('https://raw.githubusercontent.com/sergei-ditthtzynsky/function/refs/heads/main/information.json')
